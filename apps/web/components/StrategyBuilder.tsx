...
import type { ConditionGroup, EntryCondition, ExitCondition } from "@signalai/types";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
      <div className="space-y-4">
        ...
        {step === 0 && <BasicsStep />}
        {step === 1 && (
          <Card title="2. Entry — supports nested AND / OR groups">
            <GroupEditor
              kind="entry"
        ...
        {step === 2 && (
          <Card title="3. Exit — supports nested AND / OR groups">
            <GroupEditor
              kind="exit"
