...
| [requirements.md](./requirements.md) | Prerequisites (Node 22.17.1+, Python 3.10+), JS + Python deps, Supabase/Upstox setup, all env vars, 4-layer live-trading gate, one-shot setup checklist. |
